    	...
    	<p>Welcome <strong><?php echo $_SESSION['username']; ?></strong></p>
    	 ...
    	 <form method="POST" action="insert_details.php" enctype="multipart/form-data">
                           <div class="form-group">
                                  <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Podcast Name" required>
			     ...
			     <div class="form-group">                             
                              ...
                              Upload The Podcast Photo : <input type="file" name="image" required>				
